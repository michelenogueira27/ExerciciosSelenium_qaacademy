...
public class ExerciciosSelenium {
    ...
    public void testeExercicosSelenium() {
        //Exercicio 01
        driver.get("file:///C:/Users/minoguei/OneDrive%20-%20Capgemini/Documents/Register.html");
        driver.findElement(By.xpath("//body[@class='ng-scope']/section[@id='section']/div[@class='container center']/div[contains(@class,'row')]/div[@class='col-sm-6 col-md-6 col-xs-12']/form[@id='basicBootstrapForm']/div[1]/div[1]/input[1]")).sendKeys("Flavio");
